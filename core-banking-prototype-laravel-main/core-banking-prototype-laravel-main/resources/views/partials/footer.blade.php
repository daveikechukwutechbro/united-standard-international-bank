        ...
        <div class="grid grid-cols-2 md:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div class="col-span-2 md:col-span-4 lg:col-span-5">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    @if(config('brand.twitter_url'))
                    <a href="{{ config('brand.twitter_url') }}" class="w-9 h-9 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-slate-500 hover:text-white hover:border-white/[0.12] transition-all" aria-label="Twitter" target="_blank" rel="noopener">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>
                    @endif
                    @if(config('brand.linkedin_url'))
                    <a href="{{ config('brand.linkedin_url') }}" class="w-9 h-9 rounded-lg bg-white/[0.04] border border-white/[0.06] flex items-center justify-center text-slate-500 hover:text-white hover:border-white/[0.12] transition-all" aria-label="LinkedIn" target="_blank" rel="noopener">
