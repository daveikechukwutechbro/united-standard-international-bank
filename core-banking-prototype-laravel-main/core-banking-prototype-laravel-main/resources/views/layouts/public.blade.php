...
<head>
    ...
    @section('seo')
        @include('partials.seo', [
            ...
            'description' => config('brand.name', 'Zelta') . ' — Transfer, accounts, cards, KYC, exchange, wallets, and governance backed by modern core banking infrastructure.',
            'keywords' => config('brand.name', 'Zelta') . ', transfer, accounts, cards, KYC, exchange, wallets, governance, core banking, banking infrastructure, compliance, fintech',
        ])
    @show
