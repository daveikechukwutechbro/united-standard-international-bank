...
@section('seo')
    @include('partials.seo', [
        ...
        'description' => 'United Standard International Bank delivers transfer, accounts, cards, KYC, exchange, wallets, and governance alongside production-ready core banking infrastructure. Built with Laravel for modern banking and compliance.',
        'keywords' => config('brand.name', 'Zelta') . ', transfer, accounts, cards, KYC, exchange, wallets, governance, core banking, open banking, ISO 20022, PSD2, Laravel fintech',
    ])
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-28 lg:pt-28 lg:pb-36">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.08] text-sm text-slate-400 mb-4 animate-fade-in-down">
                    ...
                    61 enterprise banking modules · transfer, accounts, cards, KYC, exchange, wallets, governance
                </div>
                ...
                <p class="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-in-up" style="animation-delay: 0.15s">
                    Launch modern banking services with transfers, accounts, cards, KYC, exchange, wallets, and governance built from day one. Production-ready modules mean the infrastructure is already in place.
                </p>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="animate-on-scroll">
                    ...
                    <p class="text-lg text-slate-600 leading-relaxed mb-6">
                        A production-ready banking platform with end-to-end support for transfers, accounts, cards, KYC, exchange, wallets, and governance. Built with Laravel, DDD, and compliance-first architecture for regulated fintech.
                    </p>
                    <div class="space-y-3 mb-8">
                        @foreach([
                            'Bank accounts, virtual cards, and bank-rail transfers',
                            'KYC workflows, compliance automation, and governance controls',
                            'Multi-currency exchange, wallets, and tokenized asset support',
                        ] as $item)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                @php
                    $features = [
                        ...
                        ['route' => 'features.show', 'slug' => 'x402-protocol', 'title' => 'x402 Micropayments', 'desc' => 'HTTP-native payments with USDC on Base, Ethereum, and Solana. AI agents pay for APIs on demand with per-agent spending limits.', 'icon' => 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z', 'color' => 'emerald'],
